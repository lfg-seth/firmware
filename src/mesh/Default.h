...
#define default_node_info_broadcast_secs 600
#define default_neighbor_info_broadcast_secs 600
#define min_node_info_broadcast_secs 300 // No regular broadcasts of more than once an hour
#define min_neighbor_info_broadcast_secs 60
#define default_map_publish_interval_secs 600
